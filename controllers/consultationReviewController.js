...
exports.getReview = factory.getOne(ConsultationReview);
...
exports.createReview = catchAsync(async (req, res, next) => {
    ...
    if (!consultation.consultants.find(e => e.user._id === userId)) {
        return next(new AppError('You are not allowed to review this consultation', 401));
    }
...
exports.updateReview = catchAsync(async (req, res, next) => {
    ...
    const consultationReview = await ConsultationReview.findById(consultationReviewId);
